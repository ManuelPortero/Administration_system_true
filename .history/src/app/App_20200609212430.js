...
class App extends Component {
    ...
    render() {
        let VisTask = {visibleTask:false};
        let VisEmployee = {visibleEmployee:false};
        let VisCustomer = {visibleCustomer:false};
    ...
    <div>
            ...
            <div className="nav-content">
              <ul className="tabs tabs-transparent">
                ...
                <li className="tab"><a onClick={()=>{visibleTask:true}} href="#test2">Tasks</a></li>
              ...
              { VisTask.visibleTask ? <Tasks/> :null }
