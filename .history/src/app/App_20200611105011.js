  ...
  <div className="collapse navbar-collapse" id="navbarText">
    <ul className="navbar-nav mr-auto">
      <li className="nav-item">
        <a className="nav-link" onClick={()=>{this.CustomerChange()}} href="#">Customers <span class="sr-only">(current)</span></a>
      </li>
      <li className="nav-item">
        <a className="nav-link" onClick={()=>{this.TaksChange()}} href="#">My Tasks</a>
      </li>
      <li className="nav-item">
        <a className="nav-link" onClick={()=>{this.EmployeeChange()}} href="#">Employees</a>
      </li>
      
      <li className="nav-item">
        <a className="nav-link" onClick={()=>{this.CalcChange()}} href="#">Calculator</a>
      </li>
    </ul>
  
  </div>
  <img className="pt-4 pl-5"width="10%" src="https://ingeproconsultoria.com/wp-content/uploads/2020/02/Imagen1-SIN-FONDO.png"  alt="logo"></img>
