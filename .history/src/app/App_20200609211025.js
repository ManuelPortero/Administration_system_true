...
class App extends Component {
    ...
    render() {
        ...
        let VisEmployee = { visible:true};
        let VisCustomer = { visible:true};
    ...
    <div>
            ...
            <div className="nav-content">
              <ul className="tabs tabs-transparent">
                <li className="tab"><a onClick={()=>{VisCustomer.visible = true;}} href="#test1">Customers</a></li>
                <li className="tab"><a onClick={()=>{VisTask.visible = true;} href="#test2">Tasks</a></li>
                <li className="tab"><a onClick={()=>{VisEmployee.visible = true}} href="#test3">Employees</a></li>
              </ul>
            </div>
          </nav>
