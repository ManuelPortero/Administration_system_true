...
class KeyPadComponent extends Component {
    ...
    render() {
        return (
            ...
            <div>
            <div class="row">
            <div class="col s12 m6 l3"><p>    <button className="waves-effect waves-light btn-large" name="(" onClick={e => this.props.onClick(e.target.name)}>(</button></p></div>
            <div class="col s12 m6 l3"><p><button className="waves-effect waves-light btn-large" name="CE" onClick={e => this.props.onClick(e.target.name)}>CE</button></p></div>
            <div class="col s12 m6 l3"><p><button className="waves-effect waves-light btn-large" name=")" onClick={e => this.props.onClick(e.target.name)}>)</button></p></div>
            <div class="col s12 m6 l3"><p><button className="waves-effect waves-light btn-large" name="C" onClick={e => this.props.onClick(e.target.name)}>C</button><br/></p></div>
            </div>
