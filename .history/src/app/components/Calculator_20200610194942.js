...
export default class Calculator extends Component   {
  ...
  render () {
    ...
    <div>
    <button className="waves-effect waves-light btn-large" name="(" onClick={e => onAction(e.target.name)}>(</button>
    <button className="waves-effect waves-light btn-large" name="CE" onClick={e => onAction(e.target.name)}>CE</button>
    <button className="waves-effect waves-light btn-large" name=")" onClick={e => onAction(e.target.name)}>)</button>
    <button className="waves-effect waves-light btn-large" name="C" onClick={e => onAction(e.target.name)}>C</button>
    </div>
    <br/>
