...
class KeyPadComponent extends Component {
    ...
    render() {
        return (
            ...
            <div><button className="waves-effect waves-light btn-large" name="(" onClick={e => this.props.onClick(e.target.name)}>(</button></div>
            <div><button className="waves-effect waves-light btn-large" name="CE" onClick={e => this.props.onClick(e.target.name)}>CE</button></div>
            <div><button className="waves-effect waves-light btn-large" name=")" onClick={e => this.props.onClick(e.target.name)}>)</button></div>
            <div><button className="waves-effect waves-light btn-large" name="C" onClick={e => this.props.onClick(e.target.name)}>C</button><br/></div>
