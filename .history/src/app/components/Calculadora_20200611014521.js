...
export default class Calculadora extends Component   {
    ...
    evaluation = () => {
        ...
        else if(this.state.operator == "divided") {
            this.setState({
        ...
        else if(this.state.operator == "potence") {
            this.setState({
                input: parseInt(this.state.previousNumber)^
                parseInt(this.state.currentNumber)
    ...
    <Input>{this.state.input}</Input>    
            ...
            <Button handleClick={this.divided}>/</Button>
            </div>
            ...
            <div className="row">
                ...
                <Button handleClick={this.potence}>^</Button>
