                ...
                <div className="card">
                  <div className="card-content">
                    <form onSubmit={this.addEmployee}>
                      ...
                      <div className="row">
                        <div className="input-field col s12">
                          <textarea name="company" onChange={this.handleChange} value={this.state.company} cols="30" rows="10" placeholder="Employee company" className="materialize-textarea"></textarea>
                        </div>
                      </div>
