                ...
                <div className="card">
                  <div className="card-content">
                    <form onSubmit={this.addTask}>
                      ...
                      <div className="row">
                        <div className="input-field col s12">
                          <textarea name="comments" onChange={this.handleChange} value={this.state.comments} cols="30" rows="10" placeholder="Task Comments" className="materialize-textarea"></textarea>
                        </div>
                      </div>
