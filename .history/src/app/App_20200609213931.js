...
class App extends Component {
    ...
    render() {
        var VisTask = { visibleTask: false } ;       
        let VisEmployee= false;
        let VisCustomer = false;
    ...
    <div>
            ...
            <div className="nav-content">
              <ul className="tabs tabs-transparent">
                ...
                <li className="tab"><a onClick={()=>{VisTask.setState({visibleTask = true});}} href="#test2">Tasks</a></li>
              ...
              { VisTask.visibleTask == true ? <Tasks/> : null }
